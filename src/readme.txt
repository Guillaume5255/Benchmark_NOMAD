...
when runner/make is run, benchmark.cpp is compiled in ../run with the brackbox problems in /problems (24 analytical problems without constraints and one real blackbox, styrene)
...
runner/benchmarkJobs.sh is used to run benchmark.exe in an environment that is using SLURM for parallel computing
